                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     ...
                     <ul class="navbar-nav ml-auto">
                        ...
                        <li class="secondary-navigation">
                           <a class="fa fa-sign-in" href="<?php echo e(url('/login')); ?>"><?php echo e(__('Login')); ?></a>
                        </li>
                        <li class="secondary-navigation">
                           <a class="fa fa-pencil-square-o" href="<?php echo e(url('/register')); ?>"><?php echo e(__('Register')); ?></a>
                        </li>
                        <?php else: ?>
                        <li class="nav-item dropdown" >
                           ...
                           <b> <?php echo e(Auth::user()->lname); ?></b> <span class="caret"></span>
                           </a>
            ...
            <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
               ...
               <div class="collapse navbar-collapse" id="navbar">
                  ...
                  <ul class="navbar-nav">
                     ...
                     <?php if(auth()->guard()->guest()): ?>
                     <li class="nav-item">
                        <a href="<?php echo e(url('/login')); ?>" class="btn btn-primary text-caps btn-rounded btn-framed">Submit Ad</a>
                     </li>

                     <?php else: ?>
                     <li class="nav-item">
                        <a href="<?php echo e(url('/profile')); ?>" class="btn btn-primary text-caps btn-rounded btn-framed">Submit Ad</a>
                     </li>
                     <?php endif; ?>
                  </ul>
                  <!--Main navigation list-->
